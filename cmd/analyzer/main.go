...
import (
	...
	"github.com/asmisnik/flats-analyzer/internal/config"
	"github.com/asmisnik/flats-analyzer/internal/consumer"
	"github.com/asmisnik/flats-analyzer/internal/db"
	_ "github.com/asmisnik/flats-analyzer/internal/metrics"
...
func main() {
	...
	notifierClient := notifier.NewClient(cfg.Notifier.BaseURL)
